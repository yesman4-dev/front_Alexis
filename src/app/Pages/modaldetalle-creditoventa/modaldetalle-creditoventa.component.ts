...
@Component({
  selector: 'app-modaldetalle-creditoventa',
  templateUrl: './modaldetalle-creditoventa.component.html',
  styleUrls: ['./modaldetalle-creditoventa.component.css']
})
export class ModaldetalleCreditoventaComponent {
  ...
  generarPDF(): void {
    ...
    const pagos = credito.pagoCreditoVentas;
    ...
    const documentDefinition: TDocumentDefinitions = {
      content: [
        {
          text: 'Detalle del Crédito de Venta',
          style: 'header',
          alignment: 'center',
          margin: [0, 0, 0, 20]
        },
        {
          columns: [
            { text: `Cliente: ${credito.clienteNombre}`, style: 'subheader' },
            { text: `Estado: ${credito.estadoCredito}`, style: 'subheader', alignment: 'right' }
          ]
        },
        {
          columns: [
